...
#include "GameStateDataModule/Public/PlayerState/DreamStatePlayerState.h"
#include "Modules/ModuleManager.h"

DEFINE_LOG_CATEGORY(LogGameStateDataModule)
#define LOCTEXT_NAMESPACE "FGameStateDataModuleModule"


AGameStateBase* FGameStateDataModuleModule::Get_DreamStateGameState() const
{
...
APlayerState* FGameStateDataModuleModule::Get_DreamStatePlayerState() const
{
	UWorld* World = GEngine->GetWorld();
	APlayerState* PlayerState = World->GetFirstPlayerController()->GetPlayerState<APlayerState>();
	return PlayerState;
}
void FGameStateDataModuleModule::StartupModule()
{
    ...
    if (ModuleInterfacePtr)
    {
    	...
    	ModuleInterface->Register_IGameStateDataModuleInterface(this);
...
void FGameStateDataModuleModule::ShutdownModule()
{
...
IMPLEMENT_MODULE(FGameStateDataModuleModule, GameStateDataModule)