#include "ActorCharactersModule.h"
#include "GameFrameworkModuleInterface.h"
#include "GameFrameworkModule.h"
#include "Modules/ModuleManager.h"

#define LOCTEXT_NAMESPACE "FActorCharactersModuleModule"

DEFINE_LOG_CATEGORY(LogActorCharactersModule)



void FActorCharactersModuleModule::StartupModule()
{
	...
	if (ModuleInterfacePtr)
	{
		...
		ModuleInterface->Register_IActorCharactersModuleInterface(this);
		
	}
}

void FActorCharactersModuleModule::ShutdownModule()
{
...
IMPLEMENT_MODULE(FActorCharactersModuleModule, ActorCharactersModule)