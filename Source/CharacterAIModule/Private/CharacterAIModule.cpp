...
DEFINE_LOG_CATEGORY(LogCharacterAIModule)
#define LOCTEXT_NAMESPACE "FCharacterAIModuleModule"

void FCharacterAIModuleModule::StartupModule()
{
    ...
    if (ModuleInterfacePtr)
    {
    	...
    	ModuleInterface->Register_ICharacterAIModuleInterface(this);
    	
    }
}

void FCharacterAIModuleModule::ShutdownModule()
{
...
IMPLEMENT_MODULE(FCharacterAIModuleModule, CharacterAIModule)