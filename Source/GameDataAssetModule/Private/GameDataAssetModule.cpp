#include "GameDataAssetModule.h"
#include "GameFrameworkModuleInterface.h"
#include "GameFrameworkModule.h"
#include "Modules/ModuleManager.h"
DEFINE_LOG_CATEGORY(LogGameDataAssetModule)
#define LOCTEXT_NAMESPACE "FGameDataAssetModuleModule"

void FGameDataAssetModuleModule::StartupModule()
{
   ...
   if (ModuleInterfacePtr)
   {
   	...
   	ModuleInterface->Register_IGameDataAssetModuleInterface(this);
   	
   }
}

void FGameDataAssetModuleModule::ShutdownModule()
{
...
IMPLEMENT_MODULE(FGameDataAssetModuleModule, GameDataAssetModule)