...
#include "DreamState.h"
#include "GameFrameworkModuleInterface.h"
#include "GameFrameworkModule.h"
#include "Modules/ModuleManager.h"
DEFINE_LOG_CATEGORY(LogDreamState)
IMPLEMENT_PRIMARY_GAME_MODULE( FDefaultGameModuleImpl, DreamState, "DreamState" );

void FDreamStateModuleModule::StartupModule()
{
	...
	if (ModuleInterfacePtr)
	{
		...
		ModuleInterface->Register_IDreamStateModuleInterface(this);
		
	}
}

void FDreamStateModuleModule::ShutdownModule()
{
