#include "GameNetworkModule.h"
#include "GameFrameworkModuleInterface.h"
#include "GameFrameworkModule.h"
#include "Modules/ModuleManager.h"

DEFINE_LOG_CATEGORY(LogGameNetworkModule)
#define LOCTEXT_NAMESPACE "FGameNetworkModuleModule"

void FGameNetworkModuleModule::StartupModule()
{
    ...
    if (ModuleInterfacePtr)
    {
    	...
    	ModuleInterface->Register_IGameNetworkModuleInterface(this);
    	
    }
}

void FGameNetworkModuleModule::ShutdownModule()
{
...
IMPLEMENT_MODULE(FGameNetworkModuleModule, GameNetworkModule)